//Example Memento Design Pattern
//Created by Kedrick Karasek

/*
*************************Important Information about Memento Design Pattern*******************************************************************
1. Why?
	- Use Memento to capture and encapsulate the state of an object for later restoration
2. Terms:
	1. Originator: creates memento containing snapshot of the current state, and uses memento to restore state
	2. Memento: stores internal state of originator, only the originator may see internals
	3. Caretaker: keeps memento, does not access or examine memento's contents
 *******************************************************************************************************************************************************
*/
